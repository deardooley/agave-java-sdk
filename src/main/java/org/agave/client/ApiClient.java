...
import org.agave.client.auth.ApiKeyAuth;
import org.agave.client.auth.Authentication;
import org.agave.client.auth.HttpBasicAuth;
import org.agave.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = Settings.API_BASE_URL;
    ...
    public ApiClient() {
         ...
         */
        this.dateFormat = new SimpleDateFormat("X");
        ...
        setUserAgent("Agave-SDK/2.1.11/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("agaveApplication", new OAuth());
        authentications.put("agaveBasic", new HttpBasicAuth());
        authentications.put("agaveImplicit", new OAuth());
        authentications.put("agavePassword", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://public.agaveapi.co/
